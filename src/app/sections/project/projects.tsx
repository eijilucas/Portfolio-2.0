...
const data = [
    ...
    {id: 3, image: '/assets/api-image.jpg' ,title: 'API Service', description: 'API com objetivo de gerenciar pedidos e compras para plataformas de ecommerce com Spring.', link: 'https://github.com/eijilucas/shop-project'}
]
